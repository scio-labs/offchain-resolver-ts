...
export type FrameSystemEventRecord = {
  phase: Phase;
  event: AlephRuntimeRuntimeEvent;
  topics: Array<H256>;
};
...
export type AlephRuntimeRuntimeEvent =
  ...
  | {
      ...
      palletEvent: PalletCommitteeManagementEvent;
    }
...
export type PrimitivesVersionChange = {
...
export type PalletElectionsEvent =
   ...
   **/
  {
    ...
    data: [Array<AccountId32>, Array<AccountId32>, PrimitivesCommitteeSeats];
  };
...
export type PalletContractsEvent =
  ...
  | {
      name: "Instantiated";
      data: { deployer: AccountId32; contract: AccountId32 };
    }
  /**
  ...
  | {
      name: "CodeStored";
      data: { codeHash: H256; depositHeld: bigint; uploader: AccountId32 };
    }
  /**
  ...
  | {
      name: "CodeRemoved";
      data: { codeHash: H256; depositReleased: bigint; remover: AccountId32 };
    }
  /**
...
export type PrimitivesBanReason =
  | { type: "InsufficientUptime"; value: number }
...
export type AlephRuntimeProxyType =
  | "Any"
  | "NonTransfer"
  | "Staking"
  | "Nomination";
...
export type AlephRuntimeRuntimeCallLike =
  ...
  | {
      pallet: "CommitteeManagement";
      palletCall: PalletCommitteeManagementCallLike;
    }
...
export type AlephRuntimeSessionKeys = {
...
export type PalletUtilityCall =
  ...
  | {
      name: "AsDerivative";
      params: { index: number; call: AlephRuntimeRuntimeCall };
    }
  /**
...
export type PalletSudoCall =
  ...
  | {
      name: "SudoAs";
      params: { who: MultiAddress; call: AlephRuntimeRuntimeCall };
    };
...
export type PalletCommitteeManagementCall =
  ...
  | {
      ...
      params: { banned: AccountId32; banReason: Bytes };
    }
  /**
...
export type PalletBalancesIdAmount = {
  id: AlephRuntimeRuntimeHoldReason;
  amount: bigint;
};
...
export type PalletContractsHoldReason =
...
export type PrimitivesEraValidators = {
  reserved: Array<AccountId32>;
  nonReserved: Array<AccountId32>;
};
...
export type PalletCommitteeManagementValidatorTotalRewards = Array<
  [AccountId32, number]
>;
...
export type PrimitivesSessionCommittee = {
  finalityCommittee: Array<AccountId32>;
  blockProducers: Array<AccountId32>;
};

export type PrimitivesSessionValidatorError =
  | {
      type: "SessionNotWithinRange";
      value: { lowerLimit: number; upperLimit: number };
    }
...
export type PalletContractsPrimitivesExecReturnValue = {
  flags: PalletContractsPrimitivesReturnFlags;
  data: Bytes;
};
...
export type PalletContractsPrimitivesContractAccessError =
  | "DoesntExist"
  | "KeyDecodingFailed"
  | "MigrationInProgress";
...
export type AlephRuntimeRuntimeError =
  ...
  | {
      pallet: "CommitteeManagement";
      palletError: PalletCommitteeManagementError;
    }
