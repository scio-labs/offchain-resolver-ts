...
export interface ChainStorage<Rv extends RpcVersion>
  ...
  balances: {
    ...
    holds: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => Array<PalletBalancesIdAmount>,
      AccountId32
    >;
    ...
    freezes: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => Array<PalletBalancesIdAmount002>,
      AccountId32
    >;
  ...
  staking: {
     ...
     **/
    offendingValidators: GenericStorageQuery<
      Rv,
  ...
  session: {
    ...
    queuedKeys: GenericStorageQuery<
      Rv,
      () => Array<[AccountId32, AlephRuntimeSessionKeys]>
    >;
    ...
    nextKeys: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => AlephRuntimeSessionKeys | undefined,
      AccountId32
    >;
  ...
  aleph: {
     ...
     **/
    emergencyFinalizer: GenericStorageQuery<
      Rv,
      () => PrimitivesAppPublic | undefined
    >;
     ...
     * @param {Callback<PrimitivesAppPublic | undefined> =} callback
     **/
    queuedEmergencyFinalizer: GenericStorageQuery<
      Rv,
      () => PrimitivesAppPublic | undefined
    >;
     ...
     * @param {Callback<PrimitivesAppPublic | undefined> =} callback
     **/
    nextEmergencyFinalizer: GenericStorageQuery<
      Rv,
      () => PrimitivesAppPublic | undefined
    >;
     ...
     **/
    finalityScheduledVersionChange: GenericStorageQuery<
      Rv,
      () => PrimitivesVersionChange | undefined
    >;
  ...
  elections: {
     ...
     * @param {Callback<PrimitivesCommitteeSeats> =} callback
     **/
    nextEraCommitteeSize: GenericStorageQuery<
      Rv,
      () => PrimitivesCommitteeSeats
    >;
     ...
     * @param {Callback<Array<AccountId32>> =} callback
     **/
    nextEraReservedValidators: GenericStorageQuery<
      Rv,
      () => Array<AccountId32>
    >;
     ...
     **/
    currentEraValidators: GenericStorageQuery<
      Rv,
      () => PrimitivesEraValidators
    >;
     ...
     * @param {Callback<Array<AccountId32>> =} callback
     **/
    nextEraNonReservedValidators: GenericStorageQuery<
      Rv,
      () => Array<AccountId32>
    >;
  ...
  contracts: {
    ...
    codeInfoOf: GenericStorageQuery<
      Rv,
      (arg: H256) => PalletContractsWasmCodeInfo | undefined,
      H256
    >;
  ...
  committeeManagement: {
     ...
     * @param {Callback<number> =} callback
     **/
    sessionValidatorBlockCount: GenericStorageQuery<
      Rv,
     ...
     **/
    validatorEraTotalReward: GenericStorageQuery<
      Rv,
      () => PalletCommitteeManagementValidatorTotalRewards | undefined
    >;
     ...
     * @param {Callback<number> =} callback
     **/
    underperformedValidatorSessionCount: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => number,
      AccountId32
    >;
     ...
     **/
    banned: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => PrimitivesBanInfo | undefined,
      AccountId32
    >;
