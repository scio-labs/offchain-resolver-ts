...
export interface ContractQuery<ChainApi extends GenericSubstrateApi>
  ...
  registerOnBehalfOf: GenericContractQueryCall<
    ...
    (
      ...
      GenericContractCallResult<Result<[], AznsRegistryError>, ContractCallResult<ChainApi>>
    >
  >
  ...
  renew: GenericContractQueryCall<
    ...
    (
      ...
      GenericContractCallResult<Result<bigint, AznsRegistryError>, ContractCallResult<ChainApi>>
    >
  >
  ...
  getNameStatus: GenericContractQueryCall<
    ...
    (
      ...
      GenericContractCallResult<Array<AznsRegistryNameStatus>, ContractCallResult<ChainApi>>
    >
  >
  ...
  getAllRecords: GenericContractQueryCall<
    ...
    (
      name: string,
      options: ContractCallOptions,
    ) => Promise<GenericContractCallResult<Array<[string, string]>, ContractCallResult<ChainApi>>>
  >
  ...
  getRecord: GenericContractQueryCall<
    ...
    (
      ...
      GenericContractCallResult<Result<string, AznsRegistryError>, ContractCallResult<ChainApi>>
    >
  >
  ...
  getNamePrice: GenericContractQueryCall<
    ...
    (
      ...
      GenericContractCallResult<
        Result<[bigint, bigint, bigint, AccountId32 | undefined], AznsRegistryError>,
        ContractCallResult<ChainApi>
      >
    >
  >
  ...
  batchGetNamePrice: GenericContractQueryCall<
    ...
    (
      ...
      GenericContractCallResult<
        Array<Result<[bigint, bigint, bigint, AccountId32 | undefined], AznsRegistryError>>,
        ContractCallResult<ChainApi>
      >
    >
  >
  ...
  psp34CollectionId: GenericContractQueryCall<
    ...
    (
      options: ContractCallOptions,
    ) => Promise<GenericContractCallResult<InterfacesPsp34StandardId, ContractCallResult<ChainApi>>>
  >
